...
namespace ColaComNois.Controllers
{
    ...
    public class AdversariosController : Controller
    {
        ...
        {
            var adversarioViewModel = Mapper.Map<IList<CCN_Adversario>, IList<Adversarios>>(_adversarioRepo.ObterTodos());
        ...
        public ActionResult Details(int id)
        {
            ...
            var adversarioViewModel = Mapper.Map<CCN_Adversario, Adversarios>(adversarioPorId);
        ...
        public ActionResult Create(Adversarios adversario)
        {
            ...
            {
                var adversarioDomain = Mapper.Map<CCN_Adversario>(adversario);
        ...
        public ActionResult Edit(Adversarios adversario)
        {
            if (ModelState.IsValid)
            {
                var adversarioDomain = Mapper.Map<Adversarios, CCN_Adversario>(adversario);
